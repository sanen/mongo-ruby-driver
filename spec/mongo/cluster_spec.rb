...
describe Mongo::Cluster do
  ...
  describe '#disconnect!' do
    ...
    let(:reaper_executor) do
      cluster.instance_variable_get(:@reaper_executor)
    end
    ...
    before do
      ...
      expect(reaper_executor).to receive(:stop!).and_call_original
    end
  ...
  describe '#reconnect!' do
    ...
    before do
      ...
      expect(reaper_executor).to receive(:restart!).and_call_original
    end
